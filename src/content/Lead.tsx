	...
	return (
		<React.Fragment>
			<p>
				...
				<a href="https://www.canada.ca/en/revenue-agency/services/subsidy/emergency-wage-subsidy/cews-frequently-asked-questions.html#h_5" target="_blank" rel="noreferrer noopener">eligible remuneration </a>{` `}
				paid in respect of the applicable period (to {` `}
				<a href="https://www.canada.ca/en/revenue-agency/services/subsidy/emergency-wage-subsidy/cews-frequently-asked-questions.html#h_6" target="_blank" rel="noreferrer noopener">certain limits</a>). 
			</p>
			<p>
				The rules for calculating the subsidy changed after Period 4 from an {` `}
				<a href="https://www.videotax.com/covid19-implications-cews" target="_blank" rel="noreferrer noopener">“all or nothing” system</a>{` `}
				dependent on a 30% decline in revenue “original system”, to a {` `}
				<a href="https://www.videotax.com/web-tips-articles/major-cews-update-increased-amounts-lower-thresholds" target="_blank" rel="noreferrer noopener">scaling system</a>{` `}
