...
const GeneralNotes: React.FC<IProps> = (_props: IProps) => {
	return (
		<React.Fragment>
			...
			<p>
				The calculation can be separated into five period groups: Periods 1-4 (March 15 to July 4, 2020), Periods 5-6 (July 5 to August 29, 2020), Periods 7 – 10 (August 30 to December 19, 2020) , Periods 11-13 (December 20, 2020 to March 13, 2021), and Periods 14-16 (March 14, 2021 to June 5, 2021).
			...
			<h3>Periods 14-16</h3>
			<p>The calculations and rules will remain largely the same as for Periods 11-13 with the exception that any comparisons using March, April, or May revenues will incorporate prior period revenues from the same month in 2019 as opposed to 2020. </p>
		</React.Fragment>
	);
};
